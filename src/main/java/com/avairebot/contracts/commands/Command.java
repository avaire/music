...
public abstract class Command extends Reflectionable {
     ...
     */
    public final String generateCommandTrigger() {
        return generateCommandPrefix() + getTriggers().get(0);
    }
    ...
    public final String generateCommandPrefix() {
        return CategoryHandler.getPrefix();
    }
    ...
    private String formatCommandGeneratorString(Message message, String string) {
        return StringReplacementUtil.replaceAll(string, ":command", generateCommandTrigger());
    }
